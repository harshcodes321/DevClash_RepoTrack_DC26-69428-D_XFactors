# 🧭 RepoTrack - Repository Architecture Navigator
...
| 🤖 **AI Summaries** | Plain-English explanation of every file via MISTRAL AI LLM |
...
FastAPI Backend
  ...
  ├── MISTRAL AI LLM → Generate file summaries (batched)
...
**Backend:** FastAPI · Python AST · NetworkX · GitPython · MISTRAL AI · SQLite · aiosqlite  
...
└── backend/
    ...
    └── analyzer/
        ...
        ├── ai_engine.py               # MISTRAL AI LLM summaries + NL search
